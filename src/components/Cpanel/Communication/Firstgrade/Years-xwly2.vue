          ...
          <v-card style="overflow-x: hidden;">
            ...
            <v-card-actions>
              <v-row>
                ...
                <v-col cols="12" md="6">
                  Passed:
                  <v-btn @click="Passed()" color="grey">Stage 2</v-btn>
                </v-col>
              </v-row>
            </v-card-actions>
          </v-card>
...
export default {
  ...
  methods: {
    ...
    UpdateUser(data) {
      ...
      axios
        .put(`communication-student/${this.updateId.id}/?g=1&s=0&x=2`, fs, {
          headers: { Authorization: 'Bearer ' + accesToken }
        })
        .then(() => {
          this.dialog2 = false
    ...
    DeleteUser() {
      const accesToken = localStorage.getItem('access_token')
      axios
        .delete(`communication-student/${this.deleteId}/?g=1&s=0&x=2`, {
          headers: { Authorization: 'Bearer ' + accesToken }
        })
        .then(res => {
          this.dialog1 = false
